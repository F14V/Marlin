...
#define STRING_CONFIG_H_AUTHOR "F14V, Genius Pro" // Who made the changes.
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 9.85f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.273f }        // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0404f }          // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.0628f } // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
...
#define PIDTEMPBED
  ...
  // Genius Pro
  #define DEFAULT_bedKp 16.0
  #define DEFAULT_bedKi 1.0
  #define DEFAULT_bedKd 176.0
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 435 } // 1750 E LV8729
 ...
 */
#define S_CURVE_ACCELERATION // @@@ !!! DO NOT FORGET ABOUT THIS !!! @@@
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 27.25, -12.8, -1.4 }
